...
-- Con el select cojemos que las subcolumnas/columnas que queremos.
USE PUBLICATIONS;
SELECT 
    ...
    editorial.pub_name AS 'PUBLISHER'
FROM authors AS au
LEFT JOIN 
...
SELECT 
	...
	au.au_fname AS 'FIRST NAME',
	editorial.pub_name AS 'PUBLISHER',
	COUNT(libros.title) as 'TITLE COUNT' 
FROM authors AS au
LEFT JOIN 
titleauthor AS title ON  au.au_id = title.au_id
LEFT JOIN
